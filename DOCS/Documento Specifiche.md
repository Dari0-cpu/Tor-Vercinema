# **Specifiche progetto Tor Vercinema**
...
# Elenco Operazioni (Carico Applicativo) 
<u>Le 15 operazioni fondamentali che il sistema deve supportare: </u>
1. Registrazione nuovo Utente. 
2. Login dell'utente. 
3. Ricerca Film in programmazione per data.
4. Visualizzazione orari/sale per un Film specifico. 
5. Elenco Posti disponibili per una Proiezione.
6. Inserimento nuova Prenotazione.
7. Visualizzazione storico prenotazioni di un Utente. 
8. Ricerca dettagli Prenotazione tramite ID (per Staff).
9. Elenco posti occupati per una Proiezione imminente. 
10. Conteggio biglietti venduti vs validati. 
11. Inserimento nuovo Film e relative Proiezioni (Admin). 
12. Aggiornamento Prezzo proiezione o Capienza sala. 
13. Calcolo incasso totale giornaliero. 
14. Calcolo incasso generato da un singolo Film. 
15. Classifica dei 3 Film più visti nell'anno.
